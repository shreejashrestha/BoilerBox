/*
  ...
  Author: Takeshi Tsukamoto
  Date: June 1st 2020
  "flutter_circle_color_picker"
  Team 24 did not write or edit this code.
*/

/*
Description : The standard modes page uses this to switch between different colors and alter the level of brightness.
 */
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        const SizedBox(height: 16, child: Text("Brightness", style: TextStyle(color: Colors.white, fontSize: 12))),
                        _LightnessSlider(
